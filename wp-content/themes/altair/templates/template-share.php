...
<div <?php if(!empty($share_id)) { ?>id="<?php echo $share_id; ?>"<?php } ?> class="social_share_wrapper <?php echo $share_class; ?>">
	...
	<ul>
		...
		<li><a class="tooltip" title="<?php _e( 'Share On Pinterest', THEMEDOMAIN ); ?>" target="_blank" href="http://www.pinterest.com/pin/create/button/?url=<?php echo urlencode(get_permalink()); ?>&amp;media=<?php echo get_the_post_thumbnail_url(); ?>"><i class="fa fa-pinterest marginright"></i></a></li>
